...
class _CartService implements CartService {
  ...
  @override
  Future<Cart> getCartItems({required int id}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = id;
...
class _ProductService implements ProductService {
  ...
  Future<ProductElement> getProductById({required int id}) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ProductElement>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ProductElement.fromJson(_result.data!);
    return value;
  }
